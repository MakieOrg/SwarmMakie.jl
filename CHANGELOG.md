...
- **Breaking**: Removed `gutter` and `gutter_threshold` attributes. The width of the jitter clouds is now controlled by `width` and `gap` and options to handle points outside the margins will be added in the future.
